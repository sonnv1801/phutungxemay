      ...
      const order = new Order({
        ...
        products: await Promise.all(
          products.map(async (product) => {
            ...
            const productTotalPrice = totalOrderedQuantity * productPrice;
            const productTotalProfit = totalOrderedQuantity * productProfit;
            ...
            return {
              productCode: productCode,
              quantityOrdered: totalOrderedQuantity,
              quantityDelivered: 0,
